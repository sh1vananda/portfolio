  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-3">
        ...
        <ArrowUpRight className="w-3 h-3 text-neutral-600 group-hover:text-white transition-colors opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 duration-300" />
      </div>
